...
function Update(props) {
    ...
    const putProduct = () => {
        const requestOptions = {
            ...
            body: JSON.stringify({ "id": id,"name": name, "description": description, "price": parseInt(price) })
        };
        ...
        <form>
            ...
            <div className="form-group">
                <div className="col-md-offset-2 col-md-10">
                    <Link type="submit" onClick={putProduct} className="btn btn-default" to={{ pathname: '/' }}>Изменить</Link>
                </div>
            </div>
        </form>
    );
